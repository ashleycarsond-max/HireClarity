...
export const COVERAGE_FOOTER =
  "HireClarity Data tracks job postings on Greenhouse, Ashby, Lever and Workable boards and on company career pages. LinkedIn and Indeed restrict automated access and are not tracked — our coverage is an observed sample.";

/** Short one-liner for the tool pages and the subscribe panel. */
export const COVERAGE_SHORT =
  "HireClarity Data tracks Greenhouse, Ashby, Lever and Workable boards plus company career pages. LinkedIn and Indeed restrict automated access and are not tracked — our coverage is an observed sample.";
